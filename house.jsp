...
String driverName="com.microsoft.sqlserver.jdbc.SQLServerDriver";  
	...
	String sql="select * from houseinfo1,userinfo where houseinfo1.house_owner=userinfo.username and houseinfo1.houseid='"+houseid+"'";
	String sql1="select * from comment,userinfo where comment.email=userinfo.email and comment.housetable='1' and comment.houseid='"+houseid+"'";
...
<div id="list">
	<div class="div_1">
    	<div class="top"><%=univalent%>元/晚</div>
        <form id="form2" method="post" action="house_order.jsp?houseid=<%=houseid%>">
        <div>
			<script>
				$(function () {
        ...
        <div style="margin-top:20px;">
        	<a class="btn" style="cursor:pointer;" onclick="uporder(<%=rest%>)">立即订购</a>&nbsp;&nbsp;
    		<a href="/collection?houseid=<%=houseid%>&housetable=1" class="btn">加入收藏</a>
        </div>
        </form>
    </div>
</div>
