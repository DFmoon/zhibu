...
%>
<div id="fpbottom">
	<form action="/find_password2" method="post">
   		<span>用户名</span><input type="text" name="username" value="<%=username%>" readonly="readonly" /><br /><br />
    	<span>注册邮箱</span><input type="email" name="email" value="<%=email%>" readonly="readonly" /><br /><br />
   		<span>密码问题</span><input type="text" name="question" value="<%=question%>" readonly="readonly"/><br /><br />
    	<span>问题答案</span><input type="text" name="answer" />
        <br /><br /><br /><br />
