...
public class houseupload2 extends HttpServlet {
...
//   截取formType    
   ...
   //   截取filename
		...
		String  sql1 = "update houseinfo2 set spic='"+icon+"' where houseid='"+houseid+"'";
		String  sql2 = "update houseinfo2 set bpic='"+icon+"' where houseid='"+houseid+"'";
		if(pic.equals("1"))
		{
